...
#define __GMP_CC "gcc "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/gmp-native/6.2.1-r0/recipe-sysroot-native/usr/include -O2 -pipe"
