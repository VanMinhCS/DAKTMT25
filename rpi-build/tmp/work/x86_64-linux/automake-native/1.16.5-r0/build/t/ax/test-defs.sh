...
am_rel_srcdir='../automake-1.16.5'
am_top_srcdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/build/../automake-1.16.5'
am_top_builddir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/build'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/automake-1.16/am'
    am_automake_acdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/aclocal-1.16'
    am_bindir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/bin'
    am_datadir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share'
    am_docdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/doc/automake'
    am_pkgvdatadir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/automake-1.16'
    am_scriptdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/automake-1.16'
    am_system_acdir='/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/share/aclocal'
    ;;
  no)
...
host_alias=${host_alias-'x86_64-linux'}; export host_alias
build_alias=${build_alias-'x86_64-linux'}; export build_alias
...
MKDIR_P=${AM_TESTSUITE_MKDIR_P-'/home/ubuntu/yocto/rpi-build/tmp/hosttools/mkdir -p'}
...
EGREP=${AM_TESTSUITE_EGREP-'/home/ubuntu/yocto/rpi-build/tmp/hosttools/grep -E'}
FGREP=${AM_TESTSUITE_FGREP-'/home/ubuntu/yocto/rpi-build/tmp/hosttools/grep -F'}
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/include -O2 -pipe'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/include -O2 -pipe'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/include -O2 -pipe'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-isystem/home/ubuntu/yocto/rpi-build/tmp/work/x86_64-linux/automake-native/1.16.5-r0/recipe-sysroot-native/usr/include -O2 -pipe'}}
